 ...
 */
public class Sample2Activity extends BaseActivity implements BaseActivity.CloseActivityForResult {
	private static final String LOG_TAG = "Sample2Activity";
	
	/**
	 * PlayRTC 인터페이스를 구현한 Class
	 */
	private Sample2PlayRTC playrtc = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 영사이 없으므로 IVideoGroupView videoGroup = null
		playrtcObserver = new PlayRTCObserverImpl(this, null, popupView,  logView);

		//PlayRTCHandler 구현 개체 
		try {
			playrtc = new Sample2PlayRTC(this, playrtcObserver);
	...
	private void initUILayoutControls() {
		...
		popupView = (ChannelPopupView)findViewById(R.id.sample2_channel_info);
		logView = (SlideLogView)findViewById(R.id.sample2_logview);

		// local audio mute
		((Button)this.findViewById(R.id.btn_sample2_mute_alocal)).setOnClickListener(new Button.OnClickListener() {
			@Override
		...
		// local audio mute
		((Button)this.findViewById(R.id.btn_sample2_mute_aremote)).setOnClickListener(new Button.OnClickListener() {
			@Override
			public void onClick(View v) {
				Button b = (Button)v;
				String text = (String)b.getText();
		...
		((Button)this.findViewById(R.id.btn_sample2_command)).setOnClickListener(new Button.OnClickListener() {
			@Override
			public void onClick(View v) {
		...
		/* Channel Popup 출력 버튼 */
		((Button)this.findViewById(R.id.btn_sample2_channel)).setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
		...
		/* Channel 나가기 버튼 */
		((Button)this.findViewById(R.id.btn_sample2_disconnect)).setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
