...
public class Sample3PlayRTC extends BasePlayRTC{
	 ...
	 */
	public Sample3PlayRTC(BaseActivity activity, PlayRTCObserver oberver) 
	...
	public void setConfiguration() {
        ...
        File logPath = new File(Environment.getExternalStorageDirectory().getAbsolutePath() +
                    "/Android/data/" + activity.getPackageName() + "/files/log/sample3/");  
        ...
        File cachePath = new File(Environment.getExternalStorageDirectory().getAbsolutePath() +
                "/Android/data/" + activity.getPackageName() + "/files/cache/sample3/");  
